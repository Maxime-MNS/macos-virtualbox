...
DmiSystemProduct="MacBookPro13,2"    # Model Identifier
DmiSystemSerial="C02SPB4LGTFJ"       # Serial Number (system)
DmiSystemUuid="1338B3BF-9AB5-5DCA-BE9C-2418F26C9090" # Hardware UUID
...
DmiBoardProduct="Mac-66E35819EE2D0D05"
...
SYSTEM_UUID="cd496cd42000285ca565fbe1ab7121d0"
#   csrutil status
